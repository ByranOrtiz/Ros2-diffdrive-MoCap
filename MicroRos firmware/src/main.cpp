...
// ================================================================================
// Funcionalidad de ROS2
// ================================================================================ 
void
ros2_cmdvel_task(void * p_params)
{
  ...
  while(1) // loop()
  {
    ...
    vTaskDelay(1000 / portTICK_PERIOD_MS); // ejemplo de delay de 1 segundo (thread safe)  
  }
}
...
setup() 
{
  ...
  // Si alguna de sus librerías / rutinas requiere setup, colocarlo aquí
